...
var _user$project$PhotoGroove$initialCmd = A2(
	...
	_elm_lang$http$Http$getString('http://elm-in-action.com/mooo/list'));
		...
		switch (_p2.ctor) {
			...
			default:
				if (_p2._0.ctor === 'Ok') {
					...
					var requestedPhotos = A2(_elm_lang$core$List$map, _user$project$PhotoGroove$Photo, urls);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loadingError: _elm_lang$core$Maybe$Just('Error :(')
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
